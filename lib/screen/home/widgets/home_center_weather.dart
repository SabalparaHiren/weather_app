        ...
        return Column(
          children: [
            ...
            SimpleShadow(
              ...
              sigma: 20,
              child: Image.asset(
                getImageFromWeather(provider.weatherModel.current == null
                    ? ''
                    : provider.weatherModel.current!.weather!.first.main ?? ''),
            ...
            Row(
              children: [
                infoTab(
                  Strings.temp,
                  '${kelToCel(provider.weatherModel.current!.temp ?? 0).toStringAsFixed(2)}°',
                ),
                infoTab(
                  Strings.wind,
                  '${provider.weatherModel.current!.windSpeed}km/h',
                ),
                infoTab(
                  Strings.humidity,
                  '${provider.weatherModel.current!.humidity}%',
                ),
              ],
            ),
          ],
